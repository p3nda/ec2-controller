...
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=flowlogs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ec2.services.k8s.aws,resources=flowlogs/status,verbs=get;update;patch
